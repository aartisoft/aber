...
import com.mammutgroup.taxi.commons.util.DirectionsJSONParser;
 ...
 * @since 5/29/16.
 */
public abstract class AbstractHomeActivity extends BaseActivity implements OnMapReadyCallback {
    ...
    protected AccountHeader buildAccountHeader() {
        //TODO change this
        User currentUser = UserConfig.getInstance().getCurrentUser();
        String name = "mushtu";
        ...
        return new AccountHeaderBuilder()
                ...
                .withHeaderBackground(R.mipmap.default_drawer_header)
                .addProfiles(
                        drawerProfile
                )
                .build();
