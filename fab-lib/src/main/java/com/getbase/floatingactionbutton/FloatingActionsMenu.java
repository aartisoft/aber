...
public class FloatingActionsMenu extends ViewGroup {
  ...
  public static final int LABELS_SIDE_UNDEFINED = 2;
  ...
  private void init(Context context, AttributeSet attributeSet) {
    ...
    mLabelsPosition = attr.getInt(R.styleable.FloatingActionsMenu_fab_labelsPosition, LABELS_SIDE_UNDEFINED);
    attr.recycle();
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    if(mLabelsPosition == LABELS_SIDE_UNDEFINED)
    {
      mLabelsPosition = LABELS_ON_LEFT_SIDE;
      if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
        mLabelsPosition= getLayoutDirection();
      }
    }
